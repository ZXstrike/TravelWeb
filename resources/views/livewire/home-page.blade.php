<div>
    ...
    <div class="flex flex-col py-3 mx-8 snap-both snap-mandatory">
        <div
        ...
        <div class="w-full py-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4 md:px-10">
                @for ($i = 0; $i < 6; $i++)
                    <a href="">
                        <x-card-type1 img="https://www.planetware.com/photos-large/INA/indonesia-borobudur.jpg"
                            title="Borobudur" desc="Start From Rp. 20.0000.000.-" />
                    </a>
                @endfor
            </div>
            <x-pagination />
